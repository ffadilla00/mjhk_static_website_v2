...
function updatePreview() {
  const root = $("tvPreview");

  root.dataset.prayerSide = $("prayerPanelSide").value;

  const variables = {
    "--stage-bg": $("theme_canvas_bg")?.value,
    "--header-bg": $("theme_header_bg")?.value,
    "--header-text": $("theme_header_text")?.value,
    "--running-bg": $("theme_running_bg")?.value,
    "--running-text": $("theme_running_text")?.value,
    "--running-label-bg": $("theme_running_label_bg")?.value,
    "--running-label-text": $("theme_running_label_text")?.value,
    "--prayer-panel-bg": $("theme_prayer_panel_bg")?.value,
    "--prayer-row-bg": $("theme_prayer_row_bg")?.value,
    "--prayer-title-text": $("theme_prayer_title_text")?.value,
    "--prayer-time-text": $("theme_prayer_time_text")?.value,
    "--prayer-highlight-bg": $("theme_prayer_highlight_bg")?.value,
    "--prayer-highlight-title": $("theme_prayer_highlight_title")?.value,
    "--prayer-highlight-time": $("theme_prayer_highlight_time")?.value,
  ...
  document.querySelector(".preview-clock").style.display =
    $("headerShowClock").checked ? "" : "none";

  document.querySelector(".preview-mosque").style.display =
    $("headerShowMosque").checked ? "" : "none";
}
